...
namespace [NOMEPROJETO].Model.Dominio
{
    public static class Constantes
    {
        ...
        public static string AssuntoEmailEsqueciSenha = "[NOMEPROJETO] - Nova Senha de Acesso";
        public static string CorpoEmailEsqueciSenha = "Olá <b>{0}</b>,<br /><br />Você solicitou uma nova senha de acesso ao sistema.<br /><br />A sua nova senha é: <b>{1}</b><br /><br /><br />[NOMEPROJETO]";
